      ...
      <div class="form-grid">
        ...
        <section class="form-box">
          ...
          <div class="form-group">
            ...
            <input id="name" v-model="produto.name" type="text" required :class="{ 'is-invalid': v$.name.$error }" />
        ...
        <section class="form-box">
          ...
          <div class="upload-area" @dragover.prevent @drop.prevent="onDrop" @click="$refs.fileInput.click()" required :class="{ 'is-invalid': imagensInvalidas }">
            <div class="upload-content">
              ...
              <span class="formatos">png, jpg, webp</span>
            </div>
            <input ref="fileInput" type="file" multiple accept=".png,.jpg,.jpeg,.webp"
...
const rules = {
  name: {
    required: helpers.withMessage('O name do produto é obrigatório.', required),
    minLength: helpers.withMessage('O name deve ter ao menos 3 caracteres.', minLength(3)),
  },
  preco: {
