...
export const comentarioService = {
  async listarTodos() {
    try {
      return await apiClient.get('/comentarios');
    } catch (error) {
  ...
  async buscarPorId(id) {
    try {
      return await apiClient.get(`/comentarios/${id}`);
    } catch (error) {
  ...
  async buscarPorProduto(produtoId) {
    try {
      return await apiClient.get(`/comentarios/produto/${produtoId}`);
    } catch (error) {
  ...
  async buscarPorUsuario(userId) {
    try {
      return await apiClient.get(`/comentarios/usuario/${userId}`);
    } catch (error) {
  ...
  async criar(comentario) {
    try {
      return await apiClient.post('/comentarios', {
        ...comentario,
  ...
  async atualizar(id, dadosAtualizados) {
    try {
      return await apiClient.put(`/comentarios/${id}`, dadosAtualizados);
    } catch (error) {
  ...
  async aprovarComentario(id) {
    try {
      return await apiClient.put(`/comentarios/${id}/aprovar`, { aprovado: true });
    } catch (error) {
  ...
  async reprovarComentario(id) {
    try {
      return await apiClient.put(`/comentarios/${id}/reprovar`, { aprovado: false });
    } catch (error) {
